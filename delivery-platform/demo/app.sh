...
create () {
    ...
    gcloud beta deploy apply --file $WORK_DIR/app-templates/${APP_LANG}/deploy/pipeline.yaml
    ...
    echo "You can checkout your app source code from the followiing location"
    echo
...
create_cloudbuild_trigger () {
    ...
    TRIGGER_NAME=${APP_NAME}-clouddeploy-webhook-trigger
    #BUILD_YAML_PATH=$WORK_DIR/app-templates/${APP_LANG}/cloudbuild-build-only.yaml
